  ...
  return (
    <div className="text-center py-16 sm:py-20 animate-fade-in">
      ...
      <p className="text-muted mb-6 text-[13px]">
        {hasAgent ? "Your agent is connected. I can read files, run commands, and help with your codebase." : "Ask me anything. Connect an agent for file and shell access."}
      </p>
